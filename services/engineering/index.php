...
<div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner"><div class="wpb_wrapper">
	...
	<div class="wpb_text_column wpb_content_element  vc_custom_1457075523481" >
		<div class="wpb_wrapper">
			<h4>Civil Engineering/Contruction</h4>
<p>The design and plan the construction of roads, buildings, bridges and many other public works projects. To work in the field, you should be skilled in mathematics and able to pay attention to details. Since many civil construction projects are rather large and involve many people, you also need to be able to communicate clearly in writing and in speech.</p>
	...
	<div class="wpb_text_column wpb_content_element  vc_custom_1457075528580" >
		<div class="wpb_wrapper">
			<h4>Geotechnical Services</h4>
<p><ul>
                <li >Subsurface Explorations and Foundation Studies </li>
                <li >Slope Stability Studies Excavation Support System Design and Monitoring Settlement Analysis </li>
                <li >Pile Foundation Design, Pile Load Testing </li>
                <li >Wave Equation Analysis for Pile Driving </li>
                <li >Rock Excavation Design </li>
                <li >Earthwork Specification Preparation </li>
                <li >Construction Dewatering Design and Review </li>
                <li >Mechanically Stabilized Earth Slopes/RetainingWalls Design / Geosynthetics</li>
                <li >Technical Specifications for Drilled-Shaft Design and Load Testing</li>
